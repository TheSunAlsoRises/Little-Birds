...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.logout_button.setGeometry(QtCore.QRect(120, 200, 151, 23))
        self.logout_button.setObjectName(_fromUtf8("logout_button"))
        self.upload_scripts_button = QtGui.QPushButton(Form)
        self.upload_scripts_button.setGeometry(QtCore.QRect(120, 150, 151, 23))
        self.upload_scripts_button.setObjectName(_fromUtf8("upload_scripts_button"))
        ...
        self.upload_tweets_button = QtGui.QPushButton(Form)
        self.upload_tweets_button.setGeometry(QtCore.QRect(120, 100, 151, 23))
        self.upload_tweets_button.setObjectName(_fromUtf8("upload_tweets_button"))
        self.headline = QtGui.QLabel(Form)
        self.headline.setGeometry(QtCore.QRect(130, 50, 131, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.upload_scripts_button.setText(_translate("Form", "Upload Scripts (override)", None))
        self.back_button.setText(_translate("Form", "Back", None))
        self.upload_tweets_button.setText(_translate("Form", "Upload Tweets (override)", None))
